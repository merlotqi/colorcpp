...
- The parser is already a major public capability, but the main README still explicitly calls out these gaps as pending.
...
- The README and reference docs no longer need the current "still pending" caveat for these parser features.

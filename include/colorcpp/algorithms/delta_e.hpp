/**
 * @file delta_e.hpp
 * @brief Color difference metrics: CIELAB D65 (ΔE76 / ΔE94 / ΔE2000), CMC l:c, DIN99, and Oklab Euclidean (ΔE_OK).
 *
 ...
 * @note **CMC** (@c delta_e_cmc): Textile industry metric with configurable l:c weights.
 * @note **DIN99** (@c delta_e_din99): German standard with perceptual uniformity improvements.

...
/** @brief Alpha-aware blending with selectable blend mode; current implementation uses an encoded `rgbaf_t` working space rather than a verified linear-sRGB compositing path. */
